...
export default function (keybindings, userPreference, recentlyUsedFiles) {
  ...
  const fileMenu = {
    label: i18n.t('menu.file') + '(&F)',
    submenu: [{
      label: i18n.t('menu.newTab'),
  ...
  if (!isOsx) {
    ...
    recentlyUsedMenu.submenu.push({
      ...
      label: i18n.t('menu.clear-recently-used'),
