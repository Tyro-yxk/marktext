<template>
  <div class="pref-image">
    <h4>{{$t('preferences.category.image-option.image')}}</h4>
    <section class="image-ctrl">
      <div>{{$t('preferences.category.image-option.default-action-after-an-image-is-inserted-from-local-folder-or-clipboard')}}
        <el-tooltip class='item' effect='dark'
          :content="$t('preferences.category.image-option.clipboard-handling-is-only-fully-supported-on-macOS-and-Windows')"
          placement='top-start'>
